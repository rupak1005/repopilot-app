...
1. Impact theater: open spike with blast-layer Z from `visualizationFromFileImpact`
2. True topography 3D (instanced heights) — keep CSS map default
3. Perf budgets / fixtures documented on spike overlay
