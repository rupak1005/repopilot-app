      ...
      <DocsSection title="Repository endpoints">
        ...
        <DocsTable
          ...
          rows={[
            ...
            ['GET', '/graph', 'Module dependency graph JSON'],
            ['GET', '/architecture', 'Architecture layout payload'],
            ['GET', '/dependencies', 'Symbol/module traversal queries'],
            ['GET', '/impact', 'Downstream impact for a file path'],
            ['GET', '/hotspots', 'Module churn rankings'],
            ['GET', '/co-change', 'Files that change together'],
            ['POST', '/search/history', 'Search commit messages'],
            ['GET', '/similar-changes', 'Find similar historical diffs'],
